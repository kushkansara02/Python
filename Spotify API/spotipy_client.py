...
class SpotipyClient(object):
    ...
    scopes = { "images":"ugc-image-upload", "read_playback": "user-read-playback-state",
              ...
              "user_email":"user-read-email", "account_type":"user-read-private", "collab_playlists":"playlist-read-collaborative",
              "write_access_public_playlist":"playlist-modify-public", "read_access_private_playlists":"playlist-read-private",
    ...
    def __init__(self, username, client_id, client_secret, redirect_uri, *args, **kwargs):
    ...
    def createSpotifyObj(self):
        ...
        token = None
        try:
            token = util.prompt_for_user_token(self.username, scope = self.all_scopes, show_dialog = True, client_id = self.client_id, client_secret = self.client_secret, redirect_uri = self.redirect_uri)
